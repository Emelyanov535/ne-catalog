...
import static ru.necatalog.ozon.parser.utils.OzonConsts.OZON_MOBILE_MAIN_LINK;
...
public class OzonCategoryPage {
    ...
    private String extractUrl(Element productDiv) {
        ...
        return OZON_MOBILE_MAIN_LINK + replaceExtraParamsFromUrl(productUrlBlock.attr("href"));
    }
